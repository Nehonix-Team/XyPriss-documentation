...
A starter XyPriss server for building secure web applications
...
The server will start on `http://localhost:4567` with hot reload and TypeScript compilation enabled.
