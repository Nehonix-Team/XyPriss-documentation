...
export default function XSecMLandingPage() {
  return (
    <div className="prose prose-invert max-w-none">
      ...
      <p>
        <strong>XSec-M</strong> is an enterprise-grade cryptographic framework
        for TypeScript / JavaScript environments. It utilizes a high-performance
        Go-based core engine compiled as a static, dependency-free CLI binary to
        provide military-grade security with absolute cross-platform
        reliability.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-8">
        <div className="p-4 bg-white/[0.02] border border-white/5 rounded-xl">
          ...
          <p className="text-[10px] text-slate-400 m-0">
            Optimized execution using lightweight process spawning, bypassing
            the overhead of standard JavaScript cryptographic implementations.
          </p>
        </div>
        <div className="p-4 bg-white/[0.02] border border-white/5 rounded-xl">
          ...
          <p className="text-[10px] text-slate-400 m-0">
            Zero native compilation required. Statically linked pure Go binaries
            run flawlessly on Linux, Windows, and macOS.
          </p>
        </div>
        <div className="p-4 bg-white/[0.02] border border-white/5 rounded-xl">
          ...
          <p className="text-[10px] text-slate-400 m-0">
            Native support for Ed25519, AES-256-GCM, Argon2id, PBKDF2, HKDF,
            RSA-OAEP, and Post-Quantum algorithms.
          </p>
        </div>
      </div>
      ...
      <p>
        XSec-M is divided into specialized modules for different cryptographic
        needs:
      </p>
        ...
        {[
          {
            ...
            desc: "Foundational primitives: Hash, Random, Password manager.",
            href: "/docs/security/xsec-m/core",
          },
          {
            title: "Ed25519",
            desc: "High-performance EdDSA signature verification.",
          ...
          {
            title: "Utilities",
            desc: "Encoding and general cryptographic helpers.",
      ...
      <p>
        For maximum convenience, use the <code>Cipher</code> class to access
        core hashing and random generation primitives.
      </p>
      <CodeBlock
        language="typescript"
        code={`import { Cipher } from "xypriss-security";
