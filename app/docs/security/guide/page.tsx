...
import { ShieldCheck, Zap, AlertTriangle, Terminal, Layers, Lock, Shield, Settings, Activity } from "lucide-react";
...
export default function SecurityGuidePage() {
  return (
    <div className="prose prose-invert max-w-none">
      ...
      <p>XyPriss includes comprehensive security features to protect your application from common vulnerabilities. This guide covers basic configuration, security levels, and best practices.</p>
...
const server = createServer({
    security: {
      ...
      <p>XyPriss offers three pre-defined security levels to quickly configure your application's defensive posture.</p>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
        <div className="p-4 bg-white/[0.02] border border-white/5 rounded-xl">
          <h4 className="text-white font-semibold mb-1 flex items-center gap-2"><Shield size={16} /> Basic</h4>
        ...
        <div className="p-4 bg-white/[0.02] border border-blue-500/30 bg-blue-500/5 rounded-xl shadow-lg shadow-blue-500/5">
          <h4 className="text-blue-400 font-semibold mb-1 flex items-center gap-2"><ShieldCheck size={16} /> Enhanced</h4>
          <ul className="text-[10px] text-slate-400 m-0 list-disc pl-4 space-y-1">
        ...
        <div className="p-4 bg-white/[0.02] border border-white/5 rounded-xl">
          <h4 className="text-purple-400 font-semibold mb-1 flex items-center gap-2"><Zap size={16} /> Maximum</h4>
          <ul className="text-[10px] text-slate-400 m-0 list-disc pl-4 space-y-1">
    ...
    security: {
      ...
      <SectionHeading level={2}>Input Validation & Sanitization</SectionHeading>
      <p>Prevent XSS and injection attacks using the <code>xypriss-security</code> toolkit:</p>
      <CodeBlock language="typescript" code={`import { sanitize, validate } from "xypriss-security";
...
app.post("/api/user", (req, res) => {
    ...
    res.json({ success: true, data: cleanData });
      ...
      <p>XyPriss automatically sets secure HTTP headers using Helmet. You can customize these directives in your configuration:</p>
      <CodeBlock language="typescript" code={`const server = createServer({
    security: {
        headers: {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 my-6">
        {[
          ...
          <div key={idx} className="flex items-center gap-3 p-3 rounded-lg bg-white/[0.02] border border-white/5 text-xs text-slate-400">
    ...
    security: {
      ...
      <Callout type="info" title="XyPriss Security Shield">
        ...
        <CodeBlock language="bash" className="mt-4" code="xfpm install xypriss-security" />
      </Callout>
