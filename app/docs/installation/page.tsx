    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4 mb-8">
        ...
        <p className="text-xl text-muted-foreground leading-relaxed">
          Prepare your system for XyPriss development by installing the
          mandatory ecosystem tools.
        </p>
      </div>
      ...
      <p>
        Before running a XyPriss project, ensure the following tools are
        installed. They are <strong>mandatory</strong> — using alternative
        package managers (npm, yarn, pnpm) or runtimes may cause unexpected
          ...
          <tbody className="divide-y divide-white/5">
            <tr>
              ...
              <td className="py-4 pr-6 text-muted-foreground">
                The exclusive package manager for the XyPriss ecosystem. Handles
                native core linking.
              </td>
              <td className="py-4">
                <a href="#install-cli" className="text-primary hover:underline">
                  See below
                </a>
              </td>
            </tr>
            <tr>
              ...
              <td className="py-4 pr-6 text-muted-foreground">
                The primary JavaScript runtime used to execute XyPriss projects
                and high-speed scripts.
              </td>
              <td className="py-4">
                <a
                  href="https://bun.sh"
      ...
      <SectionHeading level={2} id="install-cli">
        Installing the CLI
      </SectionHeading>
      <p>
        The unified installer automatically detects your OS and architecture to
        install the correct XFPM binary.
      </p>
      ...
      <p>Once installed, verify that the CLI is available in your PATH:</p>
      <CodeBlock language="bash" code="xfpm --version" />

      <SectionHeading level={2} id="troubleshooting">
        Troubleshooting
      </SectionHeading>
